...
[OS]
name=OS
baseurl=http://172.16.1.109/openEuler-23.09/OS/$basearch/
enabled=1
gpgcheck=1
...
[everything]
name=everything
baseurl=http://172.16.1.109/openEuler-23.09/everything/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
...
[EPOL]
name=EPOL
baseurl=http://172.16.1.109/openEuler-23.09/EPOL/main/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
...
[update]
name=update
baseurl=http://172.16.1.109/openEuler-23.09/update/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
...
[EPOL-update]
name=EPOL update
baseurl=http://172.16.1.109/openEuler-23.09/EPOL/update/main/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
"""
