...
[OS]
name=OS
baseurl=http://192.168.0.17/openEuler-24.03-LTS-SP1/OS/$basearch/
enabled=1
gpgcheck=1
...
[everything]
name=everything
baseurl=http://192.168.0.17/openEuler-24.03-LTS-SP1/everything/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
...
[EPOL]
name=EPOL
baseurl=http://192.168.0.17/openEuler-24.03-LTS-SP1/EPOL/main/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
...
[update]
name=update
baseurl=http://192.168.0.17/openEuler-24.03-LTS-SP1/update/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
...
[EPOL-update]
name=EPOL update
baseurl=http://192.168.0.17/openEuler-24.03-LTS-SP1/EPOL/update/main/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
...
baseurl=http://192.168.0.17/openEuler-24.03-LTS-SP1/EPOL/multi_version/OpenStack/Antelope/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
...
name=multi_version-OpenStack
baseurl=http://192.168.0.17/openEuler-24.03-LTS-SP1/EPOL/update/multi_version/OpenStack/Antelope/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
"""
