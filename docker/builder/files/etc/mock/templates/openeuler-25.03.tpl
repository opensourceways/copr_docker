...
config_opts['dist'] = 'oe2503'  # only useful for --resultdir variable subst
config_opts['releasever'] = '25.03'
config_opts['package_manager'] = 'dnf'
config_opts['description'] = 'openEuler 25.03'
config_opts['extra_chroot_dirs'] = [ '/run/lock', ]
config_opts['useradd'] = '/usr/sbin/useradd -o -m -u {{chrootuid}} -g {{chrootgid}} -d {{chroothome}} {{chrootuser}}'
config_opts['bootstrap_image'] = 'docker.io/openeuler/openeuler:25.03'
...
install_weak_deps=0
protected_packages=
module_platform_id=platform:oe2503
...
[OS]
name=OS
baseurl=http://192.168.0.17/openEuler-25.03/OS/$basearch/
enabled=1
gpgcheck=1
...
[everything]
name=everything
baseurl=http://192.168.0.17/openEuler-25.03/everything/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
...
[EPOL]
name=EPOL
baseurl=http://192.168.0.17/openEuler-25.03/EPOL/main/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
...
[update]
name=update
baseurl=http://192.168.0.17/openEuler-25.03/update/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
...
[EPOL-update]
name=EPOL update
baseurl=http://192.168.0.17/openEuler-25.03/EPOL/update/main/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
"""
