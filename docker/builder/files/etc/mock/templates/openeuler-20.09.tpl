...
[OS]
name=OS
baseurl=http://172.16.1.109/openEuler-20.09/OS/$basearch/
enabled=1
gpgcheck=1
...
[everything]
name=everything
baseurl=http://172.16.1.109/openEuler-20.09/everything/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler
...
[EPOL]
name=EPOL
baseurl=http://172.16.1.109/openEuler-20.09/EPOL/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler
...
[debuginfo]
name=debuginfo
baseurl=http://172.16.1.109/openEuler-20.09/debuginfo/$basearch/
enabled=0
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler
...
[source]
name=source
baseurl=http://172.16.1.109/openEuler-20.09/source/
enabled=0
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler
...
[update]
name=update
baseurl=http://172.16.1.109/openEuler-20.09/update/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler
"""
